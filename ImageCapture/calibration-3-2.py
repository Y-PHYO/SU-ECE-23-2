...
def undistort(h, w, matrix, distortion, imageTitle):
    ...
    newPathway = split[0] + "/" + splitTitle[0] + "_Fixed." + splitTitle[1]
...
def fixPhotos(h, w, matrix, distortion):
...
undistort(height, width, mat, distort, "imagesFolder/Test_Cal-4.PNG")

# fixPhotos(height, width, mat, distort)
